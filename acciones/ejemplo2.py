...
class unitest(unittest.TestCase):
    ...
    def test_Pagina(self):
        driver = self.driver
        driver.get("https://www.google.com/") #página donde se hará el test
        driver.maximize_window()
        time.sleep(5)

        #Seleccionar la sección del menu tablas
        Tablas = driver.find_element_by_xpath("/html/body/div[1]/div[3]/form/div[1]/div[1]/div[1]/div/div[2]/input")
        Tablas.send_keys("PowerStreet")
        time.sleep(3)


        Tablas = driver.find_element_by_xpath("/html/body/div[1]/div[3]/form/div[1]/div[1]/div[3]/center/input[1]")
        Tablas.click()
        time.sleep(3)
