...
class unitest(unittest.TestCase):
    ...
    def test_Pagina(self):
        driver = self.driver
        driver.get("https://www.youtube.com/") #página donde se hará el test
        driver.maximize_window()
        time.sleep(5)

        #Seleccionar la sección del menu tablas
        Tablas = driver.find_element_by_xpath("/html/body/ytd-app/div/div/ytd-masthead/div[3]/div[2]")
        Tablas.send_keys("PowerStreet")
        time.sleep(3)

        

        Tablas = driver.find_element_by_xpath("/html/body/ytd-app/div/div/ytd-masthead/div[3]/div[2]/yt-icon-button/button/yt-icon")
        Tablas.click()
        time.sleep(3)
